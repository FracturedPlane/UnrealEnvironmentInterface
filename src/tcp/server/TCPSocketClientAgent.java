...
/**
 * Class designed to make testing other connections easier.
 * 
 * Use this class to test a TCP based connection.
 * @author Glen Berseth
 *
 */
public class TCPSocketClientAgent extends EntityTCPChannelServer
 {
 	...
 	*/
 	public static void main(String args[])
 	{
 		...
 		TCPSocketClientAgent client = new TCPSocketClientAgent();
	...
	public void run() 
	{
		...
		for (int q = 0; message.indexOf(TestingUtil.CLOSE_CONNECTION_FLAG) < 0 && q < 5; q++ )
		{
			...
			try 
			{
				...
				String attack = new String(TestingUtil.readFileAsString(props.getProperty(PROP_TEST_FILE_DIR) +
 	 	  				props.getProperty(PROP_TEST_FILE_NAME + 0)));
				System.out.println(out);
				this.NIOChannel.send(MessageFraming.START_FRAME + attack + 
						MessageFraming.END_FRAME);
			} catch (IOException e) 
			{
				// TODO Auto-generated catch block
